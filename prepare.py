...
def clean(prices):
    ...
    prices['Close'] = prices['Close'].str.replace('$','')
    prices['Open'] = prices['Open'].str.replace('$','')

    # Will Add High and Low prices later

    #prices['High'] = prices['High'].str.replace('$','')
    #prices['Low'] = prices['Low'].str.replace('$','')
